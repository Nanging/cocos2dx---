...
bool UpLayer::initSprite() {
	...
	starBound = Sprite::create("57.png");                     //装饰
...
bool UpLayer::initMenu() {
	...
	quitButton = MenuItemImage::create("69.png", "57.png", CC_CALLBACK_1(UpLayer::player, this));                              //退出按钮
