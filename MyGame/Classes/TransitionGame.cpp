...
{
	SimpleAudioEngine::getInstance()->playEffect("wav/GUITransitionOpen.wav");
	_inScene->setVisible(false);
	TransitionScene::onEnter();
	Size size = Director::getInstance()->getVisibleSize();
	//×ó±ßµÄ±³¾°
	auto leftDoor = Sprite::create("png/transition_left.png");
	...
	//×ó±ßlogo
	auto leftLogo = Sprite::create("png/logo_left.png");
	...
	//×ó±ßµÄ¼ÓÔØÍ¼Æ¬
	auto leftLoad = Sprite::create("png/load_left.png");
	...
	auto rightDoor = Sprite::create("png/transition_right.png");
	...
	auto rightLogo = Sprite::create("png/logo_right.png");
	...
	auto rightLoad = Sprite::create("png/load_right.png");
...
{
	SimpleAudioEngine::getInstance()->playEffect("wav/GUITransitionClose.wav");
